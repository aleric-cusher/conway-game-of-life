...
class StillLifePatterns:
    @staticmethod
    def block(top_left_location: Tuple[int, int] = (0, 0)) -> List[Tuple[int, int]]:
    ...
    @staticmethod
    def beehive(top_left_location: Tuple[int, int] = (0, 0)) -> List[Tuple[int, int]]:
        offset_row, offset_col= top_left_location
...
class OscillatorPatterns:
    @staticmethod
    def blinker(top_left_location: Tuple[int, int] = (0, 0)) -> List[Tuple[int, int]]:
        offset_row, offset_col= top_left_location
